...
import { FaSearch, FaTrash, FaDownload, FaFish, FaSync, FaExclamationTriangle, FaCheckCircle, FaHourglassHalf } from 'react-icons/fa';
        ...
        <div className="current-inventory">
          <div className="table-header">
            ...
            <div className="table-actions">
              ...
              <button className="add-new-catch">+ Add New Catch</button>
                ...
                <tr key={index}>
                  <td>
                    <div className="product-info">
                      <img src={`/path-to-${item.product.toLowerCase()}-icon.png`} alt={item.product} />
                      <div>
                        <p>{item.product}</p>
                        <span>{item.type}</span>
...
/*import React, { useState } from 'react';
import { FaSearch, FaTrash, FaDownload, FaFish, FaSync, FaExclamationTriangle, FaCheckCircle, FaHourglassHalf, FaBell } from 'react-icons/fa';
import { Line } from 'react-chartjs-2';
import { Chart as ChartJS, LineElement, PointElement, LinearScale, Title, CategoryScale, Tooltip, Legend } from 'chart.js';
import '../styles/InventoryManagementPage.css';
...
const InventoryManagementPage = () => {
  ...
  const [notificationCount, setNotificationCount] = useState(3); // Notification count state
